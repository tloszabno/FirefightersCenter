...
public class FirefightersMainView {
  ...
  private void initNotificationPlaceholder() {
    alarmReceivedLbl = new Label("notification placeholder");
  ...
  private void initBottomButtons() {
    ...
    confirmAlertBtn.setOnAction(event -> {
      ...
      statusText.setText("Alert Confirmed");
      alarmReceivedLbl.setText("");
      data.add(0, new AlertGuiModel("Pożar", "Kraków", "Pożar samochodu", "2"));
    });

    finishAlertBtn = new Button("Finish Alert");
    hbBtn = new HBox(10);
    hbBtn.setAlignment(Pos.BOTTOM_LEFT);
    ...
    finishAlertBtn.setOnAction(event -> {
      statusText.setFill(Color.FIREBRICK);
      statusText.setText("Alert Finished");
      alarmReceivedLbl.setText("");
    });

    reportAlertBtn = new Button("Send Report");
    hbBtn = new HBox(10);
    hbBtn.setAlignment(Pos.BOTTOM_LEFT);
    ...
    reportAlertBtn.setOnAction(event -> {
      statusText.setFill(Color.FIREBRICK);
      statusText.setText("Report sent");
      alarmReceivedLbl.setText("");
    });
  }
  ...
  private void initBottomStateText() {
    ...
    grid.add(statusText, 1, GRID_BOTTOM_STATUS_IDX, GRID_COLUMN_NUMBERS, 1);
  }
