  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active">
          <button type="button" class="menu_element_btn btn btn-primary navbar-btn active" onclick="location.href='newFireNotication.htm'">
          <span class="glyphicon glyphicon-phone-alt" aria-hidden="true"></span>
          ${text.newNotificationBtnMsg}
          </button>
        </li>
        <li>
          <button type="button" class="menu_element_btn btn btn-danger  navbar-btn" onclick="location.href='allFireNotification.htm'">
          <span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span>
          ${text.notifitacionBtnMsg}
          </button>
        </li>
        <li>
          <button type="button" class="menu_element_btn btn btn-danger  navbar-btn" onclick="location.href='allFirefightersPosts.htm'">
